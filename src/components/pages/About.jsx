        ...
        <div className="flex bg-white" style= {{height:"100vh"}}>
          <div className='flex items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2'>
            <div>
              ...
              <p className='mt-2 text-sm text-gray-500 md:text-base'>Welcome to <span class='text-indigo-600'>Food Share Mart, </span>where our goal is to create a platform so users to share food products with strangers. Simply sign up and start sharing your food with others.</p>
